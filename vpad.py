...
def changed(event=None):
    ...
    if text_editor.edit_modified():
        ...
        status_bar.config(text=f'Chararcters : {characters} Words : {words}')
...
file.add_command(label='Save As', image=save_icon,
...
# edit.add_command(label='Find', image=copy_icon,
...
view.add_checkbutton(label='Tool Bar', onvalue=True, offvalue=0, variable=show_toolbar,
                     image=toolbar_icon, compound=tk.LEFT, command=hide_toolbar)
